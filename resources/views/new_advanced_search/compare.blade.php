...
@if (is_array($bilayer_thickness) && count($bilayer_thickness) > 0 && array_sum($bilayer_thickness) != 0)
<!-- Bilayer thickness -->
<div class="row p-2 bg-solapa " style="border-radius:25px;margin:3px;padding-bottom: 10%!important;">
    <div class="chart-container">
        <div class="pt-4" style="text-align:center;">
...
@if (is_array($area_per_lipid) && count($area_per_lipid) > 0 && array_sum($area_per_lipid) != 0)
<!-- Area per lipid -->
<div class="row p-2 bg-solapa " style="border-radius:25px;margin:3px;padding-bottom: 10%!important;">
    <div class="chart-container">
        <div class="pt-4" style="text-align:center;">
