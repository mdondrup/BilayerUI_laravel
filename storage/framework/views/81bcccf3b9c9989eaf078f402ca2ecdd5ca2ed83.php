            ...
            <div class="col-md-12">
                <div class=" ">
                    <div class="card-header txt-white">
                        <h1><?php echo app('translator')->get('Trayectoria'); ?> <?php echo e($trayectoria->id); ?></h1>
                    </div>
                    <div class="card-header txt-white">
                        <h3>
                    ...
                    <div role="tabpanel" class="pt-4">
                        ...
                        <div class="tab-content">
                                                ...
                                                <div class="row g-5">
                                                    <div class=" col-12"
                                                        ...
                                                        <div class="p-3">
                                                            ...
                                                            <br><br>
                                                            <span class="txt-titulo"><?php echo e(c('campo_de_fuerza')); ?>:</span>
                                                            <span class="txt-dato">
                                                                <?php echo e($trayectoria->campo_de_fuerza->name); ?></span><br>
                                                            <span class="txt-titulo"><?php echo e(c('longitud')); ?>:</span>
                                                            <span class="txt-dato">
                                                                <?php echo e($trayectoria->trj_length); ?></span><br>
                                                            <!--<span class="txt-titulo"><?php echo e(c('campo_electrico')); ?>:</span><span class="txt-dato"> <?php echo e($trayectoria->electric_field); ?></span><br>-->
                                                            <span class="txt-titulo"><?php echo e(c('temperatura')); ?>:</span>
                                                            <span class="txt-dato"><?php echo e($trayectoria->temperature); ?>

                                                            </span><br>
                                                            <!--<span class="txt-titulo"><?php echo e(c('presion')); ?>:</span><span class="txt-dato"><?php echo e($trayectoria->pressure); ?> (<?php echo e($trayectoria->pressure_coupling); ?> <?php echo e($trayectoria->pressure_coupling_type); ?>)</span><br>-->
                                                            <span class="txt-titulo"><?php echo e(c('particulas')); ?>:</span>
                                                            <span
                                                                class="txt-dato"><?php echo e($trayectoria->number_of_atoms); ?></span><br>
                                                            <!--<span class="txt-titulo"><?php echo e(c('timestep')); ?> :</span><span class="txt-dato"><?php echo e($trayectoria->timeleftout); ?> </span><br>-->
                                                            <span class="txt-titulo"><?php echo e(c('software')); ?>:</span>
                                                            <span class="txt-dato"><?php echo e($trayectoria->software); ?> </span><br>

                                                            <!--<span class="txt-titulo"><?php echo app('translator')->get('Heteromoléculas'); ?>:</span><span class="txt-dato">  <?php echo e($trayectoria->moleculas->implode('name', ', ')); ?></span><br>-->
                                                            <span class="txt-titulo"><?php echo app('translator')->get('Iones'); ?>:</span>
                                                            <span class="txt-dato">

                                                                 <?php echo e($trayectoria->iones_num->map(function($ion) {return "{$ion->ion_name}({$ion->number})";})->implode(', ')); ?>


                                                               </span><br>

                                                               <span class="txt-titulo"><?php echo app('translator')->get('Water'); ?>:</span>
                                                               <span class="txt-dato">

                                                                   <?php echo e($trayectoria->modelos_acuaticos_num->map(function($water) {return "{$water->water_name}({$water->number})";})->implode(', ')); ?>


                                                                  </span><br>

                                                            <span class="txt-titulo"><?php echo app('translator')->get('Lipidos'); ?>:</span><br>

                                                            <span class="txt-dato"> L1:
                                                                <?php echo e($trayectoria->membranas->implode('lipid_names_l1', ', ')); ?>

                                                                (<?php echo e($trayectoria->membranas->implode('lipid_number_l1', ', ')); ?>)
                                                            </span><br>
                                                            <span class="txt-dato"> L2:
                                                                <?php echo e($trayectoria->membranas->implode('lipid_names_l2', ', ')); ?>

                                                                (<?php echo e($trayectoria->membranas->implode('lipid_number_l2', ', ')); ?>)
                                                            </span><br>
                                                            <p>
                                                                <?php
                                                    ...
                                                    <span class="txt-dato">
                                                        <a
                                                            href="<?php echo e('https://github.com/NMRLipids/Databank/tree/main/Data/Simulations/' . $trayectoria->git_path); ?>">
                                                            <span>See the system in : </span><img style="width: 120px;"
                                                                src="<?php echo e(asset('storage/images/github.png')); ?>">
                                                        </a>
                                                    </span><br>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body" style="height: 100%;">
                                    ...
                                    <div class="row">
                                        <div class="col-sm p-4">
                                            ...
                                            <!--  <h4><?php echo e($trayectoria->membrana->lipid_names_l1); ?> </h4>-->
                                        </div>
                                    </div>
                                    ...
                                    ?>
                                        <div class="col-xs-12 col-lg-6 d-flex flex-wrap cardlipids">
                                            ...
                                            <div class=" m-2 w-100" style="width: 18rem;">
                                                <div class=" ">
                                                    <h5 class=" "><?php echo e($lipido->molecule); ?></h5>
                                    ...
                                    ?>
                                        <div class="col-xs-12 col-lg-6 d-flex flex-wrap cardlipids">
                                            ...
                                            <div class=" m-2 w-100" style="width: 18rem;">
                                                <div class=" ">
                                                    <h5 class=" "><?php echo e($heteromol->molecule); ?></h5>
                            ...
                            <div role="tabpanel" class="tab-pane bg-solapa card-datos" id="homeAnalysis">
                                ...
                                <div class="card-body">
                                    <?php if(!is_null($trayectoria->analisis)): ?>
                                        <div class="row p-2">
...
.</span>
                                ...
                                ?>
                                        <div class="row p-2">
                                            <div class="col">
                                                ...
                                                <h3>Order Parameters : '<?php echo e($lipidName); ?>' </h3>
                                                <a href="<?php echo e($GitHubURLEXP); ?><?php echo e($value->order_parameters_file); ?>">Download
                                                    JSON</a>
                                                <?php
                                                ...
                                                <div class="m-2"><img class="ordeparameterlipid img-fluid"
                                                        src="<?php echo e(asset('storage/' . $pathToPeptid)); ?>"></div>
                                                <?php
                                                }
                                                ?>
                                                <div class="chart-container-half"><canvas
                                                        id="myChartOrderParamLipidsg1<?php echo e($nlip); ?>"></canvas>
                                                </div>
                                                <div class="chart-container-half"><canvas
                                                        id="myChartOrderParamLipidsg2<?php echo e($nlip); ?>"></canvas>
                                                </div>
                                                <div class="chart-container-half"><canvas
                                                        id="myChartOrderParamLipidsg3<?php echo e($nlip); ?>"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
                                    ...
                                    ?>
                                        <div class="row p-2">
                                            <div class="col-sm-12 col-md-12 chart-container-half">
                                                <h3>Order Parameters :
                                                    '<?php echo e($trayectoria->TrayectoriasHeteromoleculas->molecule_name); ?>'
                                                </h3>
                                                <?php if($trayectoria->TrayectoriasAnalysisHeteromoleculas->order_parameters_experiment != null): ?>
                                                    <a
                                                        href="<?php echo e($GitHubURLEXP); ?><?php echo e($trayectoria->TrayectoriasAnalysisHeteromoleculas->order_parameters_experiment); ?>">Download
                                                        JSON</a>
                                                <?php endif; ?>
                       ...
                       ');
                                ...
                                ?>
                                        <?php if($trayectoria->experimentsFF->implode('path')!=''): ?>
                                            <div class="row p-2">
                                                <div class="col-sm-12 col-md-12 chart-container-half">
                                                    <h3>Form Factor</h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var InfoBase = {
                ...
                height: 300,
                debug: false,
                j2sPath: "<?php echo e(asset('storage/js/jsmol/j2s')); ?>", // Ruta al j2s, si no se indica no lo encuentra
                color: "0xAAAAAA",
                disableJ2SLoadMonitor: true,
                disableInitialConsole: true,
                addSelectionOptions: false,
                serverURL: "<?php echo e(asset('storage/js/jsmol/php/jsmol.php')); ?>",
                use: "HTML5",
                deferApplet: false,
                readyFunction: null,
                script: "",
            ...
            //        InfoPeptide["script"]= "load async ";
            InfoMembrane["script"] = "load async <?php echo e($cadPath . '/conf.pdb.gz'); ?>";
            //    InfoLast_traj["script"]= "load async ";
...
<?php $__env->startSection('meta-tags'); ?>
     <?php echo $metadatos_head; ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nmrlipid/databank.nmrlipids.fi/databank/laravel/resources/views/trayectorias/show.blade.php ENDPATH**/ ?>