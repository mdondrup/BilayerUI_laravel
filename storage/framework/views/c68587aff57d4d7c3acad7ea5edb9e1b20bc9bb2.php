...
?>
<!doctype html>
<html class="welcome" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
                ...
                <div class="col-lg-8 align-self-baseline">
                    ...
                    <div class="row">
                            ...
                            <form action="<?php echo e(route('search.results')); ?>" method="get">
                                <div class="input-group mb-3 ui-widget">
                                    <input id="BasicSearch" type="text" name="text" class="form-control"
                                        placeholder="<?php echo app('translator')->get('Buscar'); ?>..." aria-label="Search field"
                                        aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="submit"
                                            id="button-addon2"><?php echo app('translator')->get('Buscar'); ?></button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-3 p-xs-1 p-sm-2">
                            ...
                            <a href="<?php echo e(route('new_advanced_search.form')); ?>"
                                class="btn btn-outline-secondary"><span><?php echo app('translator')->get('Búsqueda avanzada'); ?></span></a>
                    ...
                    <div class="col-12 m-4">
                        <div style="color:#fff;">
                            <?php echo e(StatisticsController::totals()); ?>
                    ...
                    <!--<img class="img-fluid" alt="Responsive image" src="<?php echo e(asset('storage/images/supepmem1_100.jpg')); ?>" alt="">-->
        ...
        $(function() {
            ...
            $("#BasicSearch").autocomplete({
                source: function(request, response) {
                    $.ajax({
                        url: "<?php echo e(route('search.basic')); ?>",
                        dataType: "json",
                        data: {
                            term: request.term
                        },
...
<?php /**PATH /home/nmrlipid/databank.nmrlipids.fi/databank/laravel/resources/views/welcome.blade.php ENDPATH**/ ?>