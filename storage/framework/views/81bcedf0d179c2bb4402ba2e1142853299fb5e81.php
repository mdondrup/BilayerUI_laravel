...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form id="formulario-busqueda-avanzada" action="<?php echo e(route('new_advanced_search.results')); ?>" method="get">
                    ...
                    <div class=" ">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <span class="titulo"> <?php echo app('translator')->get('Búsqueda avanzada'); ?><span>
                                </div>
                                <div class="col-xs-12 col-sm-6 text-right"
                                    ...
                                    <select id="selector-filtros" class="form-control btn-sm" name="" id=""
                                        ...
                                        <option value="0"><?php echo app('translator')->get('Agregar filtro'); ?></option>
                                        <?php $__currentLoopData = $filtros_posibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filtro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($filtro->codigo); ?>"><?php echo e($filtro->label); ?></option>
                                    ...
                                    <input type="submit" class="btn btn-primary btn-light ml-4" value="<?php echo app('translator')->get('Buscar'); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="search_result" style="padding-top: 0">
                            ...
                            <div id="filtros-entidades" class="row align-items-start p-4">
                                ...
                                <?php $__currentLoopData = $filtros_principales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filtro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    //  $numero_id++;
                                    ...
                                    ?>
                                    <div class="col-xs-12 col-md-6 align grupo-filtros p-2" style="<?php echo e($ocultarDiv); ?>"
                                        data-codigo="<?php echo e($filtro->codigo); ?>">
                                        <?php echo e($filtro->html_busqueda_avanzada_selects()); ?>
                            ...
                            <div id="filtros-propiedades" class="row align-items-start p-4">
                                ...
                                <?php $__currentLoopData = $filtros_trayectorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filtro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    if (isset($filtro->visible) && $filtro->visible) {
                                        $ocultarDiv = '';
                                    } else {
                            ...
                            <div class="col-xs-12 col-lg-12 containerSlider">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div id="slide_temp" class="col multi-range"
                                            data-initvalue="<?php echo e($temperature[0]->temperatureStart); ?>"
                                            data-endvalue="<?php echo e($temperature[0]->temperatureEnd); ?>" data-prec="2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div id="slide_1" class="col multi-range"
                                            data-initvalue="<?php echo e($Area_per_lipid[0]->Area_per_lipidStart); ?>"
                                            data-endvalue="<?php echo e($Area_per_lipid[0]->Area_per_lipidEnd); ?>" data-prec="2"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div class="col multi-range" id="slide_9"
                                            data-initvalue="<?php echo e($QualityFactor[0]->quality_totalStart); ?>"
                                            data-endvalue="<?php echo e($QualityFactor[0]->quality_totalEnd); ?>" data-prec="1"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div class="col multi-range" id="slide_10"
                                            data-initvalue="<?php echo e($Quality_HG[0]->quality_hgStart); ?>"
                                            data-endvalue="<?php echo e($Quality_HG[0]->quality_hgEnd); ?>" data-prec="1"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div class="col multi-range" id="slide_119"
                                            data-initvalue="<?php echo e($Quality_Tails[0]->quality_tailsStart); ?>"
                                            data-endvalue="<?php echo e($Quality_Tails[0]->quality_tailsEnd); ?>" data-prec="1"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div class="col multi-range" id="slide_12"
                                            data-initvalue="<?php echo e($Bilayer_thickness[0]->Bilayer_thicknessStart); ?>"
                                            data-endvalue="<?php echo e($Bilayer_thickness[0]->Bilayer_thicknessEnd); ?>"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div class="col multi-range" id="slide_12"
                                            data-initvalue="<?php echo e($Form_factor_quality[0]->Form_factor_qualityStart); ?>"
                                            data-endvalue="<?php echo e($Form_factor_quality[0]->Form_factor_qualityEnd); ?>"
                    ...
                    <div class="card-footer">
                        <input type="submit" class="btn btn-primary btn-light" value="<?php echo app('translator')->get('Buscar'); ?>">
                    </div>
            </div>
            </form>
        </div>
    ...
    <form id="formulario-busqueda-avanzada-submit" action="<?php echo e(route('new_advanced_search.results')); ?>" method="get">
...
<?php $__env->startSection('js'); ?>
    <script>
        let url_html_busqueda_avanzada = "<?php echo e(route('filtros.html_busqueda_avanzada_selects', [':codigo', ':numero'])); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nmrlipid/databank.nmrlipids.fi/databank/laravel/resources/views/new_advanced_search/form.blade.php ENDPATH**/ ?>