        ...
        <nav id="mainNav" class="navbar navbar-expand-md navbar-light ">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    ...
                    src="<?php echo e(asset('storage/images/supepmem_w_letras.png')); ?>" alt="">-->
                    <?php //{{ config('app.name') }}
                    ?>
                    NMR lipids Databank
...
<?php /**PATH /home/nmrlipid/databank.nmrlipids.fi/databank/laravel/resources/views/layouts/compare.blade.php ENDPATH**/ ?>